...
?>
<!-- wp:group {"style":{"spacing":{"margin":{"top":"0","bottom":"0"}},"border":{"top":{"color":"var:preset|color|primary","width":"2px"}}},"backgroundColor":"bg-dark","textColor":"text-normal-darkbg"} -->
...
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/inc/patterns/images/logo-sample-darkbg.png" alt="" width="180"/></figure>
<!-- /wp:image -->
...
<h4 class="has-text-normal-darkbg-color has-text-color has-background" style="background-color:#00000000;margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><?php echo esc_html__( 'Service', 'x-t9' ); ?></h4>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<div class="wp-block-group" style="border-bottom-color:var(--wp--preset--color--border-normal-darkbg);border-bottom-width:1px;margin-bottom:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30)"><!-- wp:heading {"level":4,"style":{"spacing":{"margin":{"top":"0","right":"0","bottom":"0","left":"0"},"padding":{"top":"0","right":"0","bottom":"0","left":"0"}},"color":{"background":"#00000000"}},"textColor":"text-normal-darkbg"} -->
<h4 class="has-text-normal-darkbg-color has-text-color has-background" style="background-color:#00000000;margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><?php echo esc_html__( 'Information', 'x-t9' ); ?></h4>
<!-- /wp:heading --></div>
<!-- /wp:group -->
