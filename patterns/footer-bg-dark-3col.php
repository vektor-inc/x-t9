<?php
/**
 * Title: Footer BG Dark 3columns
 * Slug: x-t9/footer/footer-bg-dark-3col
 * Categories: footer
...
?>
<!-- wp:group {"metadata":{"categories":["footer"],"patternName":"x-t9/footer/footer-bg-dark-3col","name":"Footer BG Dark 3columns"},"align":"full","style":{"spacing":{"margin":{"top":"0","bottom":"0"}},"border":{"top":{"color":"var:preset|color|primary","width":"2px"}}},"backgroundColor":"bg-dark","textColor":"text-normal-darkbg"} -->
<div class="wp-block-group alignfull has-text-normal-darkbg-color has-bg-dark-background-color has-text-color has-background" style="border-top-color:var(--wp--preset--color--primary);border-top-width:2px;margin-top:0;margin-bottom:0"><!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60"}}},"layout":{"inherit":true,"type":"constrained"}} -->
...
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/inc/patterns/images/logo-sample-darkbg.png" alt="" style="width:180px"/></figure>
<!-- /wp:image -->
...
<h4 class="wp-block-heading has-text-normal-darkbg-color has-text-color has-background" style="background-color:#00000000;margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><?php echo esc_html__( 'Service', 'x-t9' ); ?></h4>
<!-- /wp:heading --></div>
<!-- /wp:group -->

<!-- wp:navigation {"textColor":"text-normal-darkbg","showSubmenuIcon":false,"overlayMenu":"never","icon":"menu","className":"is-style-nav\u002d\u002dvertical-with-hr","fontSize":"x-small","layout":{"type":"flex","orientation":"vertical"}} /--></div>
<!-- /wp:column -->
...
<div class="wp-block-group" style="border-bottom-color:var(--wp--preset--color--border-normal-darkbg);border-bottom-width:1px;margin-bottom:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30)"><!-- wp:heading {"level":4,"style":{"spacing":{"margin":{"top":"0","right":"0","bottom":"0","left":"0"},"padding":{"top":"0","right":"0","bottom":"0","left":"0"}},"color":{"background":"#00000000"}},"textColor":"text-normal-darkbg"} -->
<h4 class="wp-block-heading has-text-normal-darkbg-color has-text-color has-background" style="background-color:#00000000;margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><?php echo esc_html__( 'Information', 'x-t9' ); ?></h4>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<!-- wp:separator {"className":"is-style-wide","backgroundColor":"border-normal-darkbg"} -->
...
<!-- wp:group {"align":"full","className":"mt-0","style":{"border":{"top":{"color":"var:preset|color|border-normal-darkbg","width":"1px"}}},"layout":{"inherit":true,"type":"constrained"}} -->
...
<div class="wp-block-group" style="padding-top:0.5rem;padding-bottom:0.5rem"><!-- wp:navigation {"textColor":"text-secondary-darkbg","overlayMenu":"never","className":"is-style-nav\u002d\u002dtext-inline","fontSize":"x-small","layout":{"type":"flex","orientation":"horizontal"}} /-->

<!-- wp:paragraph {"className":"has-text-secondary-darkbg-color has-text-color","style":{"typography":{"textTransform":"uppercase","textAlign":"center"}},"textColor":"text-secondary-darkbg","fontSize":"x-small"} -->
