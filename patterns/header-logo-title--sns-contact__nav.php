...
<div class="wp-block-button"><a class="wp-block-button__link has-primary-background-color has-background has-x-small-font-size has-custom-font-size wp-element-button" style="padding-top:0rem;padding-bottom:0rem">Contact</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<div class="wp-block-button"><a class="wp-block-button__link has-primary-background-color has-background has-x-small-font-size has-custom-font-size wp-element-button" style="padding-top:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30)">Contact</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
