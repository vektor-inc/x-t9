...
<!-- wp:group {"metadata":{"name":"Initial Header"},"align":"full","style":{"spacing":{"padding":{"left":"0rem","right":"0rem"}}},"layout":{"inherit":true,"type":"constrained"}} -->
...
<div class="wp-block-buttons" style="margin-top:0px;margin-bottom:0px"><!-- wp:button {"backgroundColor":"primary","style":{"spacing":{"padding":{"top":"0rem","bottom":"0rem"}}},"fontSize":"x-small"} -->
<div class="wp-block-button"><a class="wp-block-button__link has-primary-background-color has-background has-x-small-font-size has-custom-font-size wp-element-button" style="padding-top:0rem;padding-bottom:0rem"><?php echo esc_html__( 'Contact', 'x-t9' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->

<!-- wp:navigation {"ref":1504,"overlay":"navigation-overlay","icon":"menu","className":"nav\u002d\u002dopen\u002d\u002dlg-up nav\u002d\u002dfirst-nowrap is-style-nav\u002d\u002dactive-border-bottom","style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"fontSize":"x-small","layout":{"type":"flex","justifyContent":"right","orientation":"horizontal","flexWrap":"nowrap"}} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<!-- wp:group {"metadata":{"name":"Scrolled Header"},"className":"is-style-scrolled-header-fixed","backgroundColor":"bg-primary","layout":{"inherit":true,"type":"constrained"}} -->
...
<div class="wp-block-group" style="padding-top:0"><!-- wp:navigation {"ref":1504,"overlay":"navigation-overlay","icon":"menu","className":"nav\u002d\u002dopen\u002d\u002dlg-up nav\u002d\u002dfirst-nowrap is-style-nav\u002d\u002dactive-border-bottom","style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"fontSize":"x-small","layout":{"type":"flex","justifyContent":"right","orientation":"horizontal","flexWrap":"nowrap"}} /-->

<!-- wp:buttons {"style":{"spacing":{"margin":{"top":"0px","bottom":"0px"}}},"layout":{"type":"flex","justifyContent":"right"}} -->
<div class="wp-block-buttons" style="margin-top:0px;margin-bottom:0px"><!-- wp:button {"backgroundColor":"primary","style":{"spacing":{"padding":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|30"}}},"fontSize":"x-small"} -->
<div class="wp-block-button"><a class="wp-block-button__link has-primary-background-color has-background has-x-small-font-size has-custom-font-size wp-element-button" style="padding-top:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30)"><?php echo esc_html__( 'Contact', 'x-t9' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
