...
?>
<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/inc/patterns/images/x-t9-featured-sky.jpg","hasParallax":true,"dimRatio":20,"overlayColor":"black","minHeight":0,"isDark":false,"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50"},"margin":{"top":"0","bottom":"0"}}}} -->
<div class="wp-block-cover alignfull is-light has-parallax" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)"><span aria-hidden="true" class="wp-block-cover__background has-black-background-color has-background-dim-20 has-background-dim"></span><div role="img" class="wp-block-cover__image-background has-parallax" style="background-position:50% 50%;background-image:url(<?php echo esc_url( get_template_directory_uri() ); ?>/inc/patterns/images/x-t9-featured-sky.jpg)"></div><div class="wp-block-cover__inner-container"><!-- wp:group {"layout":{"inherit":true,"type":"constrained"}} -->
...
<h2 class="is-style-vk-heading-plain has-white-color has-text-color"><?php echo esc_html__( 'Let\'s embark on a new journey', 'x-t9' ); ?></h2>
<!-- /wp:heading -->
...
<figure class="wp-block-image alignright size-full"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/inc/patterns/images/x-t9-icon-large-trans.png" alt=""/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div></div>
