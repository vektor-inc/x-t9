<?php
/**
 * Title: Post List Section
 * Slug: x-t9/featured/featured-post-list
 * Categories: featured
 * Description:
 *
 * @package WordPress
...
?>
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"0","bottom":"0"},"margin":{"top":"0","bottom":"0"}}},"backgroundColor":"bg-secondary","layout":{"type":"constrained"}} -->
...
<h2 class="has-text-align-center" id="information"><?php echo esc_html__( 'Information', 'x-t9' ); ?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-button has-custom-font-size has-x-small-font-size"><a class="wp-block-button__link wp-element-button" href="<?php echo esc_url( get_post_type_archive_link( 'post' ) ); ?>"><?php echo esc_html__( 'Information list', 'x-t9' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:query --></div>
<!-- /wp:group -->
