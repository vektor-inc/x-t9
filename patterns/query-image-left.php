<?php
/**
 * Title: X-T9 Query (Post List) image left
 * Slug: x-t9/query-image-left
 * Categories: query
...
?>
<!-- wp:query {"query":{"perPage":"10","pages":"0","offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false},"displayLayout":{"type":"list"},"layout":{"inherit":true}} -->
