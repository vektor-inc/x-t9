...
<!-- wp:navigation {"showSubmenuIcon":false,"icon":"menu","className":"is-style-nav\u002d\u002dtext-inline","fontSize":"x-small","layout":{"type":"flex","justifyContent":"center","orientation":"horizontal"}} /-->

<!-- wp:social-links {"iconColor":"text-secondary","iconColorValue":"rgba(0,0,0,0.5)","openInNewTab":true,"size":"has-normal-icon-size","className":"is-style-logos-only","style":{"spacing":{"blockGap":{"top":"var:preset|spacing|40","left":"var:preset|spacing|40"},"margin":{"top":"var:preset|spacing|40","right":"0","bottom":"0","left":"0"}}},"layout":{"type":"flex","justifyContent":"center"}} -->
...
<div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--40);margin-bottom:0;padding-top:0;padding-bottom:var(--wp--preset--spacing--40)"><!-- wp:paragraph {"className":"has-text-secondary-color has-text-color","style":{"typography":{"textTransform":"uppercase","textAlign":"center"}},"textColor":"text-secondary","fontSize":"x-small"} -->
