...
<figure class="wp-block-image size-full is-resized"><img src="http://localhost:8888/wp-content/themes/x-t9/inc/patterns/images/logo-sample-darkbg.png" alt="" width="180"/></figure>
<!-- /wp:image -->
...
<div class="wp-block-group" style="border-bottom-color:var(--wp--preset--color--border-normal-darkbg);border-bottom-width:1px;margin-bottom:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30)"><!-- wp:heading {"level":4,"style":{"spacing":{"margin":{"top":"0","right":"0","bottom":"0","left":"0"}}},"textColor":"text-normal-darkbg","className":"is-style-vk-heading-plain"} -->
<h4 class="is-style-vk-heading-plain has-text-normal-darkbg-color has-text-color" style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0">Contents</h4>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<div class="wp-block-group" style="border-bottom-color:var(--wp--preset--color--border-normal-darkbg);border-bottom-width:1px;margin-bottom:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30)"><!-- wp:heading {"level":4,"style":{"spacing":{"margin":{"top":"0","right":"0","bottom":"0","left":"0"}}},"textColor":"text-normal-darkbg","className":"is-style-vk-heading-plain"} -->
<h4 class="is-style-vk-heading-plain has-text-normal-darkbg-color has-text-color" style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0">Information</h4>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<!-- wp:group {"className":"mt-0","layout":{"inherit":true,"type":"constrained"}} -->
...
<div class="wp-block-group" style="padding-top:0.5rem;padding-bottom:0.5rem"><!-- wp:navigation {"ref":11229,"textColor":"text-secondary-darkbg","overlayMenu":"never","className":"nav\u002d\u002dtext-inline nav\u002d\u002ddarkbg","layout":{"type":"flex","justifyContent":"center"},"fontSize":"x-small"} /-->
