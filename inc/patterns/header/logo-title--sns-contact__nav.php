...
return array(
	...
	<div class="wp-block-group scrolled-header-fixed has-bg-base-background-color has-background"><!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between"}} -->
