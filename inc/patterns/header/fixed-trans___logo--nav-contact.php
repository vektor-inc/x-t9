...
return array(
	...
	'content'    => '<!-- wp:group {"tagName":"header","metadata":{"name":"Header Transparent"},"className":"alignfull","style":{"position":{"type":"fixed","top":"0px"},"spacing":{"padding":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|30"}},"color":{"background":"#00000066"},"elements":{"link":{"color":{"text":"var:preset|color|bg-primary"}}}},"textColor":"bg-primary","layout":{"type":"constrained"}} -->
