<?php
/**
 * Fixed Trans | Logo -- Nav - Contact
 *
 * @package vektor-inc/x-t9
 */

return array(
	'title'      => __( 'Fixed Trans | Logo -- Nav - Contact', 'x-t9' ),
	'categories' => array( 'header' ),
	'blockTypes' => array( 'core/template-part/header' ),
	'content'    => '<!-- wp:group {"tagName":"header","className":"alignfull","style":{"position":{"type":"fixed","top":"0px"},"spacing":{"padding":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|30"}},"color":{"background":"#00000066"},"elements":{"link":{"color":{"text":"var:preset|color|bg-primary"}}}},"textColor":"bg-primary","layout":{"type":"constrained"}} -->
...
<div class="wp-block-group site-logo--set" style="padding-top:0;padding-bottom:0"><!-- wp:navigation {"ref":43,"overlay":"navigation-overlay","icon":"menu","className":"nav\u002d\u002dopen\u002d\u002dlg-up nav\u002d\u002dfirst-nowrap is-style-nav\u002d\u002dactive-border-bottom","fontSize":"x-small","layout":{"type":"flex","justifyContent":"right","orientation":"horizontal","flexWrap":"nowrap"}} /-->
