...
return array(
	...
	<div class="wp-block-group is-style-default has-small-font-size" style="margin-top:0;margin-bottom:0"><!-- wp:navigation {"ref":11229,"className":"is-style-nav\u002d\u002dactive-border-bottom"} /--></div>
	<!-- /wp:group --></div>
	<!-- /wp:group -->
	...
	<div class="wp-block-group scrolled-header-fixed has-bg-primary-background-color has-background" style="margin-top:0;margin-bottom:0"><!-- wp:group {"style":{"spacing":{"margin":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|30"}}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between"}} -->
	...
	<!-- wp:group -->
	<div class="wp-block-group"><!-- wp:navigation {"ref":11229,"className":"nav\u002d\u002dopen\u002d\u002dlg-up is-style-nav\u002d\u002dactive-border-bottom","fontSize":"small"} /--></div>
	<!-- /wp:group --></div>
	<!-- /wp:group -->
