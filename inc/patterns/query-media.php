...
return array(
	...
	<!-- wp:post-excerpt {"moreText":"' . esc_html__( 'Read more', 'x29' ) . '"} /--></div>
	<!-- /wp:column --></div>
	<!-- /wp:columns -->
	...
	<!-- wp:query-pagination-previous {"label":"' . esc_html__( 'Prev', 'x29' ) . '"} /-->
	
	<!-- wp:query-pagination-numbers /-->
	
	<!-- wp:query-pagination-next {"label":"' . esc_html__( 'Next', 'x29' ) . '"} /-->
