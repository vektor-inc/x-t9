<?php
/**
 * Footer BG Bright ver2
 *
 * @package vektor-inc/x-t9
 */

return array(
	'title'      => __( 'Footer BG Bright ver2', 'x-t9' ),
...
<div class="wp-block-group has-text-color has-bg-light-gray-background-color has-background"><!-- wp:group {"style":{"spacing":{"padding":{"top":"2rem","bottom":"2rem"}}},"layout":{"inherit":true}} -->
<div class="wp-block-group" style="padding-top:2rem;padding-bottom:2rem"><!-- wp:image {"align":"center","id":2623,"width":180,"height":45,"sizeSlug":"full","linkDestination":"media"} -->
<figure class="wp-block-image aligncenter size-full is-resized"><a href="http://xt9dev.local/wp-content/uploads/2021/01/head-logo-bk.png"><img src="http://xt9dev.local/wp-content/uploads/2021/01/head-logo-bk.png" alt="" class="wp-image-2623" width="180" height="45"/></a></figure>
<!-- /wp:image -->
...
<!-- wp:navigation {"layout":{"type":"flex","justifyContent":"center"},"fontSize":"x-small"} /-->
...
<div class="wp-block-group" style="padding-top:0.5rem;padding-bottom:0.5rem"><!-- wp:paragraph {"align":"center","style":{"typography":{"textTransform":"uppercase"}},"fontSize":"x-small"} -->
