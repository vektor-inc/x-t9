...
return array(
	'title'      => __( 'Footer BG Secondary 3columns', 'x-t9' ),
	...
	<figure class="wp-block-image size-full is-resized"><img src="' . esc_url( get_template_directory_uri() ) . '/inc/patterns/images/logo-sample.png" alt="" width="180"/></figure>
	<!-- /wp:image -->
	...
	<h4 class="is-style-vk-heading-default has-transparent-background-color has-background" style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">' . esc_html__( 'Information', 'x-t9' ) . '</h4>
	<!-- /wp:heading --></div>
	<!-- /wp:group -->
	...
	<div class="wp-block-group" style="padding-top:0.5rem;padding-bottom:0.5rem"><!-- wp:navigation {"showSubmenuIcon":false,"overlayMenu":"never","className":"is-style-nav\u002d\u002dtext-inline","layout":{"type":"flex","justifyContent":"center"},"fontSize":"x-small"} /-->
